...
const Stock = ({state}) => {
    ...
    let GAS1 = state.filter((f) => { return f.point === "GAS1" })
    let GAS2 = state.filter((f) => { return f.point === "GAS2" })
    let Mart1 = state.filter((f) => { return f.point === "Mart1" })
    let Mart2 = state.filter((f) => { return f.point === "Mart2" })
